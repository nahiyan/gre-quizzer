...
var $author$project$Main$Model = F6(
	function (wordMeanings, mode, quizRange, wordsListRange, quizOptions, markedOptions) {
		return {y: markedOptions, H: mode, M: quizOptions, m: quizRange, I: wordMeanings, s: wordsListRange};
	});
...
var $author$project$Data$data = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			...
			_Utils_Tuple2(
			2,
			_Utils_Tuple2('Abdicate', 'To give up a position, right, or power')),
			_Utils_Tuple2(
			3,
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							y: A3($elm$core$Dict$insert, wordIndex, optionIndex, model.y)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
					...
					if (!_v0.$) {
							...
							A2(
								...
								function (index) {
									...
									var options = A2(
										$elm$core$List$map,
										function (index_) {
											var _v7 = ((!correctOptionInIndices) && _Utils_eq(minOptionIndex, index_)) ? _Utils_Tuple2(0, index) : _Utils_Tuple2(1, index_);
											var result = _v7.a;
											var finalIndex = _v7.b;
										...
										optionIndices);
									var markedCorrectClass = function (correct) {
											...
											F2(
												function (_v4, acc) {
													...
													if (acc) {
														...
														var _v6 = A2($elm$core$Dict$get, index, model.y);
														if (!_v6.$) {
															var j = _v6.a;
															return (_Utils_eq(j, i) && (!result)) ? true : acc;
														} else {
															return acc;
														}
													}
									...
									return A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('my-3' + markedCorrectClass)
													]),
												_List_fromArray(
													[
														$elm$html$Html$text(
													...
													F2(
														function (optionIndex, _v2) {
															...
															var contextualClass = function () {
																var _v3 = A2($elm$core$Dict$get, index, model.y);
																if (!_v3.$) {
						...
						return _List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('table table-sm table-striped')
									]),
								_List_fromArray(
									[
										A2(
												...
												return A2(
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$elm$html$Html$Attributes$class('fw-bold small-text')
																]),
															_List_fromArray(
																[
																	$elm$html$Html$text(
