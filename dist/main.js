...
var $author$project$Main$UpdateQuizRangeStart = function (a) {
	return {$: 'UpdateQuizRangeStart', a: a};
};
var $author$project$Main$UpdateWordsListRangeEnd = function (a) {
	return {$: 'UpdateWordsListRangeEnd', a: a};
};
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$value(
												$elm$core$String$fromInt(model.quizRange.a)),
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$value(
												$elm$core$String$fromInt(model.quizRange.b)),
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$placeholder('Start'),
												$elm$html$Html$Attributes$value(
												$elm$core$String$fromInt(model.wordsListRange.a)),
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$placeholder('End'),
												$elm$html$Html$Attributes$value(
												$elm$core$String$fromInt(model.wordsListRange.b)),
